...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    draw: function() {
        ...
        if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) c = !0;
            ...
            for (f = p; f < q; f += n)
                if (p = s * f + this.min, d && this.max - this.min > 5 * this.min && (p -= this.min), p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p)
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function() {
        ...
        for (J = T; J <= fa; J++) {
            ...
            if (l && void 0 == this.openField)
                for (var kb = J + 1; kb < d.length && (!d[kb] || !(Ra = d[J + 1].axes[f.id].graphs[b]) ||
            ...
            if (va) {
                ...
                switch (g) {
                    case "line":
                        if (isNaN(U)) w || (this.drawLineGraph(v, t, N, O), v = [], t = [], N = [], O = []);
                        else {
                        ...
                        break;
                    case "smoothedLine":
                        if (isNaN(U)) w || (this.drawSmoothedGraph(v, t, N, O), v = [], t = [], N = [], O = []);
                        else {
                            if (Math.abs(D - $a) >= bb || Math.abs(C - ab) >= bb) v.push(D), t.push(C), $a = D, ab = C;
                            sa = D;
                            ta = C;
                        ...
                        if (!isNaN(U)) {
                            ...
                            if (!(U < Fb && ia < Fb || U > Gb && ia > Gb)) {
                                ...
                                if (q) {
                                    ...
                                    ca += Rb - P;
                                    ca = AmCharts.fitToBounds(ca, -P + H * ba, n - P);
                    ...
                    case "candlestick":
                        if (!isNaN(ia) && !isNaN(U)) {
                            ...
                            if (q) {
                                ...
                                nb && U >= ia && (Ka = 0);
                                var qa = new AmCharts.Cuboid(e, L, ca, E, H, Ca, Ka, Q, oa, X, ja, s, q, $, Sa),
                                    sb, tb;
                    ...
                    case "ohlc":
                        if (!(isNaN(ia) || isNaN(lb) ||
                            ...
                            if (q) {
                                ...
                                var zb = D - h / 2,
                                    zb = AmCharts.fitToBounds(zb, 0, m),
                                    Ib = AmCharts.fitToBounds(D, 0, m),
                                    Ab = D + h / 2,
                                    Ab =
                ...
                if (!aa && !isNaN(U)) {
                    ...
                    if (this.end - this.start <= Jb || 0 === Jb) {
                        var Sb = this.createBullet(y, da, ea, J),
                            Kb = this.labelText;
                        if (Kb) {
    ...
    drawLineGraph: function(a, b, c, d) {
        ...
        if (1 < a.length) {
            ...
            if (0 < f || 0 < t)
                if (n = a.join(";").split(";"), q = b.join(";").split(";"), m = g.type, "serial" == m ? 0 < c.length ? (c.reverse(), d.reverse(), n = a.concat(c), q = b.concat(d)) : e.rotate ? (q.push(q[q.length - 1]), n.push(u), q.push(q[0]), n.push(u), q.push(q[0]), n.push(n[0])) : (n.push(n[n.length - 1]), q.push(u),
                ...
                if (c.mouseIsOver || F || B || this.forceShow)
                    if (this.forceShow = !1, B) {
                        ...
                        if (0 < this.cursorAlpha) {
                            ...
                            0 < w && !this.zooming ? isNaN(this.previousX) ? E.translate(t, u) : (E.translate(this.previousX, this.previousY), E.animate({
                                translate: t + "," + u
                            }, w, "easeOutSine")) : E.translate(t, u);
                            this.previousX = t;
                            this.previousY =
                                u;
                            E.show()
                        ...
                        if (a != this.previousIndex || I != this.previousMostCloseGraph)
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], z && this.valueBalloonsEnabled && w && c.balloon.enabled) {
                                ...
                                for (g = 0; g < z.length; g++)
                                    if (t = z[g], v = NaN, (!this.oneBalloonOnly || t == I) && t.showBalloon && !t.hidden && t.balloonText && ("step" == t.type && "left" == t.stepDirection && (q = this.data[a + 1]), q)) {
                        ...
                        b ? (h = {
                            type: "changed"
                        }, h.index = a, h.chart = this.chart, h.zooming = F, h.mostCloseGraph = I, h.position = s ? f : e, h.target = this, c.fire("changed", h), this.fire("changed",
